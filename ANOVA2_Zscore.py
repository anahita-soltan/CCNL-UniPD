...
anova1_result_dir = r'C:\Users\Admin\Documents\Mistry\data\Analysis\ANOVA\Normalized\New'
output_dir = r'C:\Users\Admin\Documents\Mistry\data\Analysis\ANOVA\Filtered'
    ...
    for layer in layers:
        ...
        for _, neuron in df_anova1.iterrows():
            ...
            if np.isnan(normalized_activations).any():
                continue  # Skip this neuron if zscore results in NaN values
